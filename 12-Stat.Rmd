# Analyse statistique et visualisation graphique {#c12-Stat}
...
str(RP)
```
On a donc `r ncol(RP)` variables et plus de 4 millions d'observations pour l'ensemble de l'Ile de France
...
![](images/Equipement automobile des ménages_94_RP2017.png)
...
![](images/Ancienneté d'emménagement dans la résidence principale en 2017.png)
